...
(function() {
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    function Store(element, options) {
      ...
      this.annotations = [];
      this.initTask = new _Task({
        name: "load annotations",
        code: function(task) {
          if (!Annotator.supported()) {
            task.failed("Annotator is not supported.");
          }
          _this.initPending = true;
          return _this._getAnnotations();
        }
      });
    }
    ...
    Store.prototype._onLoadAnnotations = function(data) {
      ...
      if (this.initPending) {
        ...
        return this.initTask.dfd.ready();
      }
    };
    ...
    Store.prototype._onError = function(xhr) {
      ...
      if (this.initPending) {
        this.initPending = false;
        return this.initTask.dfd.failed("API request failed.");
      }
    };
